    ...
    <footer className="border-t border-white/10 bg-[var(--footer)] text-white">
      <Container className="grid gap-10 py-12 md:grid-cols-2 lg:grid-cols-[1.4fr_0.8fr_0.8fr_1fr] lg:gap-12 lg:py-16">
        ...
        <div>
          ...
          <ul className="mt-4 space-y-3 text-sm text-white/65">
            <li>
              <a className="transition-colors hover:text-white" href="https://sklep.tmidc.pl/regulamin-pm-11.html">
                {t('terms')}
              </a>
            </li>
            <li>
              <a className="transition-colors hover:text-white" href="https://sklep.tmidc.pl/polityka-prywatnosci-i-informacja-o-cookie-pm-20.html">
                {t('privacy')}
              </a>
            </li>
            <li>
              <a className="transition-colors hover:text-white" href="https://sklep.tmidc.pl/zasady-wysylki-pm-16.html">
                {t('shipping')}
              </a>
            </li>
          </ul>
        ...
        <div>
          ...
          <ul className="mt-4 space-y-4 text-sm text-white/70">
            <li>
              <a href="tel:+48781702472" className="flex items-start gap-3 transition-colors hover:text-white">
                <Phone className="mt-0.5 size-4 shrink-0" />
                +48 781 702 472
              </a>
            </li>
            <li>
              <a href="mailto:sklep@tmidc.pl" className="flex items-start gap-3 transition-colors hover:text-white">
      ...
      <div className="border-t border-white/10">
        <Container className="flex min-h-16 flex-col justify-center gap-1 py-4 text-xs text-white/45 sm:flex-row sm:items-center sm:justify-between sm:py-0">
          <p>© {new Date().getFullYear()} Teknomont. {t('rights')}</p>
